...
\setminted[latex]{breaklines,breaksymbolleft={\phantom{\ttfamily aaaa}}}
...
The Supervisory Commitee approval is created in a similar manner, using the \mintinline{latex}{supervisoryapproval} environment. \marginnote{The wording for Supervisory Commitee approval will be generated differently for postgraduate and \texttt{undergrad} theses.}
